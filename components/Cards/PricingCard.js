    ...
    <Card className={title === 'Pro' ? classes.bordered : ''}>
      <div className={cx(classes.priceHeader, title === 'Pro' ? classes.hasBg : '')}>
        <CardHeader
          ...
          className={cx(title === 'Free' ? text.secondaryColor : text.primaryColor, classes.cardHeader)}
        />
        <div className={classes.cardPricing}>
          <h2 className={cx(title === 'Free' ? text.textSecondary : text.textPrimary, text.title)}>
            $
            {price}
          </h2>
